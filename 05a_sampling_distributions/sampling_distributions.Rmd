...
If you are interested in estimating the proportion of people who don't think the work scientists do benefits them, you can use the `distrACTION` tool to survey.`sample_n` command to survey the population.
...
Now open the `Generate and Display Data` submenu. Name our new variable `samples` and chanfe number of samples to 1, then click `Draw samples`. Go back to your data set, and you will see a single number in the samples column. This is the number of people from our 50 who responded that science does not benefit society. 

XXXXXXXXXXXX Continue here
