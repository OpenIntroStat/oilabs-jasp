...
Instead, you can use JASP to fit the linear model (a.k.a. regression line). Clcik `Regression`, then `Linear Regression` in the classical menu. For the dependent variable, select `pf_score` and for covariates, select `pf_expression_control`.
